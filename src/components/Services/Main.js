    ...
    <div>
      <div>
        <h1 className="text-2xl md:text-4xl font-semibold text-center my-4 md:my-8">
          🎯<span className="bg-turbo-500">Solution</span> driven Business
          Websites
        </h1>
      ...
      <h1 className="my-10 md:px-4 px-2 py-3 bg-turbo-500 md:mx-40 mx-8 text-md md:text-2xl font-semibold">
        Interested? Contact{" "}
